  ...
  <div align="center">
    <table width="1000" border="1">
      <tr>
        ...
        <td height="38" class="menuactive"><div align="center"><a href="home.php"><t>Home<t></a></div></td>
  ...
  <div align="center">
    ...
    <table width="1000" border="0">
      ...
      <tr>
        ...
        <td><button class="btn btn-warning btn-sm review">Review</button></td>
      </tr>
      <?php endwhile;?>
...
<script type="text/javascript">
    $(".review").click(function(){
        ...
        if(confirm('Do you want to review to this record ?'))
        {
            $.ajax({
               url: 'review.php',
               type: 'GET',
