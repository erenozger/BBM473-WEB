  ...
  <div align="center">
    <table width="1000" border="1">
      <tr>
        ...
        <td height="38" class="menuactive"><div align="center"><a href="movies.php">Movies</a></div></td>
  ...
  <div align="center">
    <table width="1500" border="0">
      ...
      <?php
            ...
            $sql = "SELECT m.movie_name,m.movie_type,c.contentdetails,m.rating,d.mod_nick FROM movies as m, createmoviesrel as c, moderator as d WHERE m.movie_id = c.movie_id AND c.mod_id = d.mod_id ORDER BY m.rating DESC LIMIT 50;";
            if($stmt = mysqli_prepare($link, $sql)){
              if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) > 0){
                  ...
                  mysqli_stmt_bind_result($stmt, $moviename1, $moviegenre1,$moviedetails1,$rating1,$addedby);
                  while(mysqli_stmt_fetch($stmt)){
                    echo "<tr><td>".$moviename1."</td><td>".$moviegenre1."</td><td>".$moviedetails1."</td><td>".$rating1."</td><td>".$addedby."</td></tr>";
