...
<div id="menu">
  <div align="center">
    ...
    <p>
        ...
        <td height="38" class="menuactive"><div align="center"><a href="moderator.php"><t>Moderator Profile<t></a></div></td>
    ...
    <form align = "center"action="home.php" method="post">
      ...
      <table width="350" border="1">
        <tr>
          ...
          <input type="checkbox" name="h">Games
          <input type="checkbox" name="h">Movies
          <input type="checkbox" name="h">Musics
          <input type="checkbox" name="h">Series
        </tr>
      </table>
    </form>
  </div>
