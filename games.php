  ...
  <div align="center">
    <table width="1000" border="1">
      <tr>
        ...
        <td height="38" class="menuactive"><div align="center"><a href="games.php">Games</a></div></td>
        <td><div align="center"><a href="movies.php">Movies</a></div></td>
        <td><div align="center"><a href="musics.php">Musics</a></div></td>
        <td><div align="center"><a href="series.php">Series</a></div></td>
  ...
  <div align="center">
    <table width="1000" border="0" >
      ...
      <?php
            ...
            $sql = "SELECT g.game_name,g.game_firm,c.contentdetails,g.rating,g.gametype,m.mod_nick FROM games as g , creategamesrel as c, moderator as m WHERE g.game_id = c.game_id AND c.mod_id = m.mod_id ORDER BY g.rating DESC LIMIT 50;";
            if($stmt = mysqli_prepare($link, $sql)){
              if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) > 0){
                  ...
                  mysqli_stmt_bind_result($stmt, $gamename1, $gamefirm1,$contentdetails1,$rating1,$gametype1,$addedby);
                  while(mysqli_stmt_fetch($stmt)){
                    echo "<tr><td>".$gamename1."</td><td>".$gamefirm1."</td><td>".$contentdetails1."</td><td>".$rating1."</td><td>".$gametype1."</td><td>".$addedby."</td></tr>";
