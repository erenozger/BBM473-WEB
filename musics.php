  ...
  <div align="center">
    <table width="1000" border="1">
      <tr>
        ...
        <td height="38" class="menuactive"><div align="center"><a href="musics.php">Musics</a></div></td>
  ...
  <div align="center">
    <table width="1000" border="0">
      ...
      <?php
            ...
            $sql = "SELECT m.music_name,m.music_artist,c.contentdetails,m.rating,d.mod_nick FROM music as m, createmusicrel as c, moderator as d WHERE m.music_id = c.music_id AND c.mod_id = d.mod_id ORDER BY m.rating DESC LIMIT 50;";
            if($stmt = mysqli_prepare($link, $sql)){
              if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) > 0){
                  ...
                  mysqli_stmt_bind_result($stmt, $musicname1, $musicartist1,$musicgenre1,$rating1,$addedby);
                  while(mysqli_stmt_fetch($stmt)){
                    echo "<tr><td>".$musicname1."</td><td>".$musicartist1."</td><td>".$musicgenre1."</td><td>".$rating1."</td><td>".$addedby."</td></tr>";
                  }
